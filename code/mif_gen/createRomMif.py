...
def main():
    ...
    parser.add_argument("--name",
                        default="new_mif",
                        help="name of the mif file")
    parser.add_argument("--oam",
                        help="include this flag to have mif header set to oam specs"
                        action="store_true")
    parser.add_argument("--vram",
                        help="include this flag to have mif header set to vram specs"
                        action="store_true")
    parser.add_argument("--bin_path",
                        help="bin file input, specify the path")

    args = parser.parse_args()

    args.name  = args.name.replace(".mif", "")
   ...
   dir_path = "mif_files/"
   mif_file_path = dir_path + f"{args.name}.mif"
